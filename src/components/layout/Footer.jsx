      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-muted-foreground max-w-xs leading-relaxed">{t(lang, 'footer_desc')}</p>
          </div>
          <div>
          ...
          <div>
            <h4 className="text-sm font-semibold mb-4">{t(lang, 'footer_company')}</h4>
            <ul className="space-y-2.5 text-sm text-muted-foreground">
              <li><span className="text-xs">DONKOV VENTURES</span></li>
              <li><Link to="/" className="hover:text-foreground transition-colors">{t(lang, 'footer_home')}</Link></li>
            </ul>
          </div>
        </div>
        <div className="border-t border-border mt-10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">{t(lang, 'footer_copy')}</p>
          <p className="text-xs text-muted-foreground">{t(lang, 'footer_tagline')}</p>
        </div>
      </div>
    </footer>
  );
