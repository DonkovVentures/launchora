...
export default function StepNiche({ value, onChange }) {
  return (
    <div>
      <h2 className="font-display text-2xl sm:text-3xl font-bold text-foreground mb-2">Who is your product for?</h2>
      <p className="text-muted-foreground mb-8">Choose the niche or audience your product targets. This helps AI create a more focused, valuable product.</p>
      ...
      <div className="mt-4">
        <label className="text-sm font-medium text-foreground block mb-2">Or describe your own niche</label>
        <input
          type="text"
          placeholder="e.g. yoga teachers, pet owners, travelers..."
