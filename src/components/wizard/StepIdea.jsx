export default function StepIdea({ value, onChange, productType, niche }) {
  ...
  return (
    <div>
      <h2 className="font-display text-2xl sm:text-3xl font-bold text-foreground mb-2">Describe your product idea</h2>
      <p className="text-muted-foreground mb-8">
        Tell the AI what you want to create. Be as specific as you like — the more detail you add, the better your product will be.
      </p>
      ...
      <textarea
        ...
        placeholder="Describe the product you want to create in plain language..."
        rows={7}
      ...
      <div className="flex items-center justify-between mt-3">
        <p className="text-xs text-muted-foreground">Be specific about who it's for and what problem it solves.</p>
